...
module KVSAlg2 : 
 sig 
  ...
  val coq_StateRec_rect :
    ...
    coq_Clock) -> coq_Clock -> (SysPredefs.coq_NId * coq_Clock) list -> 'a2)
    -> 'a1 coq_StateRec -> 'a2
  ...
  val coq_UpdateRec_rect :
    (SysPredefs.coq_NId -> coq_Clock -> (SysPredefs.coq_NId * coq_Clock) list
    -> 'a2) -> 'a1 coq_UpdateRec -> 'a2
  ...
  val sender_dep : 'a1 coq_UpdateRec -> (SysPredefs.coq_NId * coq_Clock) list
